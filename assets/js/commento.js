!(function(B, i) {
  ...
  function Je(e, o) {
    ...
    (i.id = f),
      ...
      De(m, "profile-button"),
      (n.innerText = e.name),
      (a.innerText = "تنظیمات اعلان"),
      (c.innerText = "ویرایش پروفایل"),
      (m.innerText = "خروج"),
      Ue(m, B.logout),
      console.log(e),
      Ue(a, Fe, o.unsubscribeSecretHex),
      Ue(c, _e),
      Ie(i, "style", "display: none"),
      "undefined" !== e.link && Ie(n, "href", e.link),
      "undefined" === e.photo
        ? (((t = Ae("div")).style.background = l),
          (t.innerHTML = e.name[0].toUpperCase()),
          De(t, "avatar"))
        : (Ie(
            (t = Ae("img")),
            "src",
            ae + "/api/commenter/photo?commenterHex=" + e.commenterHex
          ),
          De(t, "avatar-img")),
      Ne(r, t),
      Ne(r, n),
  ...
  function $e(e) {
    ...
    (t.id = ie + e),
      De(t, "markdown-help"),
      (m.innerHTML = "<b>پررنگ</b>"),
      (l.innerHTML = "متن احاطه شده توسط <pre>**دو ستاره**</pre>"),
      (r.innerHTML = "<i>کج</i>"),
      (a.innerHTML = "متن احاطه شده توسط <pre>*ستاره*</pre>"),
      (s.innerHTML = "<pre>کد</pre>"),
      (u.innerHTML = "کد احاطه شده توسط <pre>`اکسان گراو`</pre>"),
      (v.innerHTML = "<strike>خط کشیده</strike>"),
      (f.innerHTML = "متن احاطه شده توسط <pre>~~دو مد~~</pre>"),
      (g.innerHTML = '<a href="https://example.com">لینک</a>'),
      (x.innerHTML = "<pre>[لینک](https://example.com)</pre> و یا لینک خالی"),
      (w.innerHTML = "<blockquote>نقل‌قول</blockquote>"),
  ...
  function Qe(e, o) {
    ...
    return (
      ...
      De(m, "button"),
      De(m, "submit-button"),
      De(l, "markdown-button"),
      De(n, "button-margin"),
      Ie(i, "placeholder", "افزودن دیدگاه"),
      Ie(a, "type", "checkbox"),
      Ie(c, "for", w + e),
      (c.innerText = "دیدگاه ناشناس"),
      (m.innerText = !0 === o ? "ذخیره تغییرات" : "افزودن دیدگاه"),
      (l.innerHTML = "<b>نـ &#8595;</b> &nbsp; نشانه‌گذاری"),
  ...
  function oo(e) {
    ...
    (o.id = l),
      ...
      ge || fe
        ? le || he
          ? (Ne(t, no("این دیدگاه قفل شده‌است و افزودن دیدگاه ممکن نیست.")),
            Re(Se(l)))
          : (Ne(t, o), Ne(t, Qe("root")))
          ...
          (function() {
            ...
            Ze)) {
              ...
              (t.id = y + n),
                ...
                n === He && De(t, "sort-policy-button-selected"),
                (t.innerText = Ze[n]),
                Ue(t, eo, n),
                Ne(o, t);
            }
    ...
    if ("" !== s) {
      ...
      qe(re + "/api/comment/new", e, function(e) {
        if (e.success) {
          ...
          var o = "";
          "unapproved" === e.state
            ? (o = "دیدگاه شما در انتظار تائید است.")
            : "flagged" === e.state &&
              (o = "دیدگاه به عنوان اسپم شناخته شده و در انتظار تائید است."),
            "" !== o && Me(Se(k + r), no(o));
          var n = Ce;
    ...
    return (
      e.forEach(function(e) {
        ...
        if (
          ...
          (x.title = "حذف"),
          xe === e.commentHex
            ? (b.title = ve ? "غیرچسبان" : "دیدگاه چسبانده شد.")
            : (b.title = "چسبان"),
          (c.title = e.creationDate.toString()),
          (i.style.borderRight = "2px solid " + k),
          e.deleted ? (n.innerText = "[حذف شد]") : (n.innerText = t.name),
          (d.innerHTML = e.html),
          (c.innerHTML = (function(e, o) {
            var n = e - o;
            return n < 5e3
              ? "همین الآن"
              : n < 6e4
              ? Math.round(n / 1e3) + " ثانیه پیش"
              : n < 36e5
              ? Math.round(n / 6e4) + " دقیقه پیش"
              : n < 864e5
              ? Math.round(n / 36e5) + " ساعت پیش"
              : n < 2592e6
              ? Math.round(n / 864e5) + " روز پیش"
              : n < 94608e7
              ? Math.round(n / 2592e6) + " ماه پیش"
              : Math.round(n / 94608e7) + " سال پیش";
          })(M, e.creationDate)),
          (m.innerText = io(e.score)),
          "undefined" === t.photo
            ? (((o = Ae("div")).style.background = k),
            ...
            : (Ie(
                (o = Ae("img")),
                "src",
                ae + "/api/commenter/photo?commenterHex=" + t.commenterHex
              ),
              De(o, "avatar-img")),
          De(i, "card"),
        ...
        Ue(p, B.replyShow, e.commentHex),
          "undefined" !== t.link &&
            ...
            Ie(n, "href", t.link),
          Ne(s, v),
          e.deleted || (Ne(s, h), Ne(s, f)),
          e.commenterHex === Ce ? Ne(s, u) : e.deleted || Ne(s, p),
          !e.deleted && ve && "root" === S && Ne(s, b),
          e.deleted || (!ve && e.commenterHex !== Ce) || Ne(s, x),
          ve && "approved" !== e.state && Ne(s, g),
          e.deleted || ve || xe !== e.commentHex || Ne(s, b),
          Ie(s, "style", "width: " + 32 * (s.childNodes.length + 1) + "px;");
        ...
        w && (De(w, "body"), Ne(y, w)),
          Ne(i, r),
          Ne(i, y),
          (e.deleted && ("true" === D || null === w)) || Ne(N, i);
      }),
    ...
    if ("" !== r) {
      ...
      qe(re + "/api/comment/edit", o, function(e) {
        if (e.success) {
          ...
          var t = "";
          "unapproved" === e.state
            ? (t = "دیدگاه شما در انتظار تائید است.")
            : "flagged" === e.state &&
              (t =
                "دیدگاه شما به عنوان اسپم شناخته شده و در انتظار تائید است."),
            "" !== t && Me(Se(k + i), no(t));
        } else ze(e.message);
      });
  ...
  function po(e, o, n) {
    qe(
      ...
      function(e) {
        ...
        Ge(),
          We("commentoCommenterToken", e.commenterToken),
          Je(e.commenter, e.email),
          B.allShow(),
          Re(Se(l)),
          null !== n
  ...
  function e() {
    for (
      ...
      if (e[o].src.match(/\/js\/commento\.js$/)) {
        ...
        void 0 !== n && (me = n),
          (t = Oe(e[o], "data-css-override")),
          (a = Oe(e[o], "data-auto-init")),
          void 0 === (c = Oe(e[o], "data-id-root")) && (c = "commento"),
          (r = Oe(e[o], "data-no-fonts")),
          (D = Oe(e[o], "data-hide-deleted"));
      }
  }
  (B.commentApprove = function(i) {
    ...
    (B.vote = function(e) {
      ...
      (i = m[0]),
        ...
        (a.innerText = io(
          parseInt(a.innerText.replace(/[^\d-.]/g, "")) + t - n
        )),
        qe(re + "/api/comment/vote", c, function(e) {
          if (!e.success)
            return (
              ze(e.message),
              Ee(i, "upvoted"),
    ...
    (B.editShow = function(e) {
      if (!(e in we && we[e])) {
        var o = Se(j + e);
        (we[e] = !0),
          o.replaceWith(Qe(e, !0)),
          (Se(b + e).value = se[e].markdown);
        var n = Se(J + e);
        Ee(n, "option-edit"),
          De(n, "option-cancel"),
          (n.title = "انصراف از ویرایش"),
    ...
    (B.commentoAuth = function(e) {
      ...
      !(function(e, o) {
        ...
        if (o.success) {
          Ge(),
            We("commentoCommenterToken", o.commenterToken),
            (i.location =
              re +
              "/api/oauth/" +
              n +
    ...
    (B.popupRender = function(n) {
      ...
      (o.id = H),
        ...
        De(r, "oauth-buttons"),
        De(c, "login-box-subtitle"),
        De(m, "oauth-buttons-container"),
        De(l, "oauth-buttons"),
        De(w, "login-box-close"),
        De(ce, "root-min-height"),
        (g.innerText = "رمزعبور خود را فراموش کرده‌اید؟"),
        (b.innerText = "حسابی ندارید؟ یکی بسازید."),
        (s.innerText = "با ایمیل خود وارد شوید."),
        (f.innerText = "ادامه"),
        (c.innerText = "با حساب اجتماعی خود وارد شوید."),
        (t.innerText = "ورود با " + parent.location.host + " authentication"),
        Ue(f, B.passwordAsk, n),
        Ue(g, B.forgotPassword, n),
        Ue(b, B.popupSwitch, n),
        Ue(w, B.loginBoxClose),
        Ie(e, "style", "display: none; opacity: 0;"),
        Ie(v, "name", "email"),
        Ie(v, "placeholder", "ایمیل"),
        Ie(v, "type", "text");
      var y = 0;
      if (
        ...
        De(k, "button"),
          ...
          Ne(o, t),
          Ne(o, i),
          (0 < y || ye.commento) && Ne(o, a);
      }
      (Te = 0 < y && (Ne(o, c), Ne(m, l), Ne(o, m), !0)),
        Ne(p, v),
        Ne(p, f),
        Ne(u, p),
        Ne(h, g),
        Ne(x, b),
        0 < y && ye.commento && Ne(o, d),
        ye.commento && (Ne(o, s), Ne(o, u), Ne(o, h), Ne(o, x)),
        Ne(o, w),
        (ke = "login"),
        (e.innerHTML = ""),
        Ne(e, o);
    ...
    (B.popupSwitch = function(e) {
      var o = Se(C);
      Te && (Re(Se(P)), Re(Se(O)), Re(Se(R)), Re(Se(U))),
        ye.sso && (Re(Se(A)), Re(Se(E)), Re(Se(R)), Re(Se(U))),
        Re(Se(N)),
        Re(Se(M)),
        (o.innerText = "ایجاد حساب"),
        (ke = "signup"),
        B.passwordAsk(e),
        Se(L).focus();
    }),
    ...
    (B.passwordAsk = function(e) {
      ...
      Re(Se(S)),
        Re(Se(N)),
        Re(Se(M)),
        Te && 0 < ye.length && (Re(Se(R)), Re(Se(U)), Re(Se(O)), Re(Se(P))),
        (i =
          "signup" === ke
            ? ((o = ["name", "website", "password"]),
              ...
              ["نام", "وبسایت", "رمزعبور"])
            : ((o = ["password"]), (n = [u]), (t = ["password"]), ["رمزعبور"])),
        (a.innerText =
          "signup" === ke
            ? "پروفایل خود را کامل کنید."
            : "برای ورود، رمزعبور خود را وارد کنید.");
      for (var c = 0; c < o.length; c++) {
        ...
        if (
          ...
          De(s, "email-button"),
            (s.innerText = ke),
            Ue(s, "signup" === ke ? B.signup : B.login, e),
            Ne(l, s);
        }
        Ne(r, m);
      }
    ...
    (B.commentSticky = function(o) {
      if ("none" !== xe) {
        ...
        null === e
          ? (xe = "none")
          : (Ee(e, "option-unsticky"), De(e, "option-sticky"));
      }
      (xe = xe === o ? "none" : o),
        vo(function() {
          var e = Se(Q + o);
          xe === o
            ? (Ee(e, "option-sticky"), De(e, "option-unsticky"))
            : (Ee(e, "option-unsticky"), De(e, "option-sticky"));
        });
    }),
    ...
    (B.loginBoxClose = function() {
      var e = Se(m),
        o = Se(T);
      Ee(e, "blurred"),
        Ee(ce, "root-min-height"),
        Ie(o, "style", "display: none");
    }),
  ...
  var fo = !(B.main = function(e) {
    if (null !== (ce = Se(c))) {
      null === Le && (Le = ce.getBoundingClientRect().width < 450),
        De(ce, "root"),
        "true" !== r && De(ce, "root-font"),
        (function() {
          var e = Ae("div");
          (e.id = T), Ne(ce, e);
        })(),
      ...
      var o = (function() {
        ...
        return (
          ...
          De(n, "logo"),
          De(t, "logo-text"),
          Ie(n, "href", "https://commento.io"),
          Ie(n, "target", "_blank"),
          (t.innerText = "قدرت گرفته از کامنتو"),
          Ne(n, t),
          Ne(o, n),
          Ne(e, o),
          e
      ...
      Xe(ae + "/css/commento.css", "window.commento.loadCssOverride()"),
        Ve(function() {
          !(function(o) {
            var e = {
              commenterToken: Ye(),
            ...
            !(function() {
              ...
              (e.id = d),
                (o.id = n),
                De(e, "mod-tools"),
                (o.innerHTML = ge ? "بازکردن دیدگاه‌ها" : "بستن دیدگاه‌ها"),
      ...
      console.log(
        "[commento] error: no root element with ID '" + c + "' found"
      );
  });
  ...
  var go = function() {
    var e = i.readyState;
    "loading" === e
      ? i.addEventListener("readystatechange", go)
      : "interactive" === e
      ? ho()
      : "complete" === e && ho();
  };
