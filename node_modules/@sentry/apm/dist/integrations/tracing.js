...
var Tracing = /** @class */ (function () {
    ...
    function Tracing(_options) {
        ...
        Tracing.options = tslib_1.__assign(tslib_1.__assign({}, defaults), _options);
    }
    /**
        ...
        if (options && typeof options.autoPopAfter === 'number') {
            ...
            setTimeout(function () {
                Tracing.popActivity(index_1, {
                    autoPop: true,
                    status: spanstatus_1.SpanStatus.DeadlineExceeded,
                });
        ...
        if (keys.length) {
            ...
            if (Tracing._heartbeatCounter >= 3) {
                if (Tracing._activeTransaction) {
                    ...
                    Tracing.finishIdleTransaction(utils_1.timestampWithMs());
                }
            }
        ...
        try {
            ...
            var updateLCP_1 = function (entry) {
                ...
                if (entry.startTime < firstHiddenTime_1) {
                    ...
                    Tracing._lcp = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, (entry.id && { elementId: entry.id })), (entry.size && { elementSize: entry.size })), { value: entry.startTime });
                }
            };
        ...
        addGlobalEventProcessor(function (event) {
            ...
            if (Tracing.options.maxTransactionDuration !== 0 && event.type === 'transaction' && isOutdatedTransaction) {
                ...
                if (event.contexts && event.contexts.trace) {
                    event.contexts.trace = tslib_1.__assign(tslib_1.__assign({}, event.contexts.trace), { status: spanstatus_1.SpanStatus.DeadlineExceeded });
                    event.tags = tslib_1.__assign(tslib_1.__assign({}, event.tags), { maxTransactionDurationExceeded: 'true' });
                }
            }
            return event;
        });
